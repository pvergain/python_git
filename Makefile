...
build:
	docker build --tag pvergain/python_git:3.9.6-slim-buster .
...
run:
	...
	docker run pvergain/python_git:3.9.6-slim-buster

push:
	docker push pvergain/python_git:3.9.6-slim-buster
