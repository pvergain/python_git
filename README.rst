...
::
    ...
    python_git on  main [!] via 🐍 v3.9.4
    ❯ make build
    docker build --tag pvergain/python_git:3.9.4-slim-buster .
    ...
    Successfully tagged pvergain/python_git:3.9.4-slim-buster
    ...
    python_git on  main [!] via 🐍 v3.9.4
    ❯ make push
    docker push pvergain/python_git:3.9.4-slim-buster
